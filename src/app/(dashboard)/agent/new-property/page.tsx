          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="card p-6 space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <label htmlFor="featured" className="text-sm text-gray-700">Mark as featured listing</label>
              </div>
            </div>
            ...
            <div className="card p-6 space-y-4">
              ...
              {features.length > 0 && (
                <div className="flex flex-wrap gap-2">
                  {features.map((f) => (
                    <span key={f} className="flex items-center gap-1 px-2 py-1 bg-primary-50 text-primary-700 text-xs rounded-full">
                      {f}
            ...
            {/* Images */}
            <div className="card p-6 space-y-4">
              <h2 className="text-lg font-semibold text-gray-900">Photos (up to 10)</h2>
